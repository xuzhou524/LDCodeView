...
@interface LDCodeView () <UITextFieldDelegate>
{
...
- (instancetype)initWithFrame:(CGRect)frame
    ...
    if (self) {
        ...
        linecolor  = lColor;
        textcolor = [LDColor ldgray98];
        
        self.layer.borderWidth = 1;
        self.layer.borderColor = lColor.CGColor;
        
        textFont = [UIFont fontWithName:@"Helvetica" size:font];
...
- (void)beginEdit {
    if (_textField == nil) {
        ...
        _textField.frame =  CGRectMake(0, 0, ASX(330 -12), ASX(50));
        ...
        UIView *barView = [[UIView alloc] initWithFrame:CGRectMake(0,0, ScreenWidth,35)];
        barView.backgroundColor = [LDColor backgroudColor];
        UIButton *button = [[UIButton alloc] initWithFrame:CGRectMake(ScreenWidth - 60, 3,50, 30)];
        [button setTitle:@"完成" forState:UIControlStateNormal];
        [button setTitleColor:[LDColor ldBlue_44_84_150] forState:UIControlStateNormal];
        [barView addSubview:button];
    
        _textField.inputAccessoryView = barView;
    ...
    switch (_codeType) {
        case CodeViewTypeCustom:
        {
            ...
            for (NSInteger i = 0; i < textArray.count; i ++) {
                ...
                [num drawInRect:CGRectMake(startX, (self.frame.size.height - textFont.lineHeight - LineBottomHeight - LineHeight)/2, wordWidth,  textFont.lineHeight) withAttributes:@{NSFontAttributeName:textFont,NSForegroundColorAttributeName:textcolor}];
            }
